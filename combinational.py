...
def createme(name,address, mobno, emailid,linkid, summary, companynames, comyourrole, yearrange, descslist, schoolnames, degreenams, schoolyears, marks, skillnames,filenamee,skilldesc):
    #data to insert
    #name = "Farhan Ahmed"
